...
public class ClassPathImageProviderTestCase {
	...
	public void loadPNGWithoutUsingImageSize() throws Exception {
		IImageProvider imageProvider = new ClassPathImageProvider(
				ClassPathImageProviderTestCase.class, "logo.png");
	...
	public void loadPNGAndUseImageSize() throws Exception {
		...
		IImageProvider imageProvider = new ClassPathImageProvider(
				ClassPathImageProviderTestCase.class, "logo.png", useImageSize);
		Assert.assertEquals(ImageFormat.png, imageProvider.getImageFormat());
	...
	@Test
	public void loadPNGAndModifyUseImageSize() throws Exception {
		// Load image
		boolean useImageSize = true;
		IImageProvider imageProvider = new ClassPathImageProvider(
				ClassPathImageProviderTestCase.class, "logo.png", useImageSize);
