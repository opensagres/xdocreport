...
public class PPTXSlidePreprocessorWithVelocityTestCase  extends TestCase {
	...
	public void testname() throws Exception {
		...
		preprocessor.preprocess("test", reader, writer, null, metadata, formatter,
