...
public class MainVithVelocityTestCase {
	...
	public void testGenerateODTWithJSONFile() throws Exception {
		String[] args = { "-in", BASE_DIR + "/ODTHelloWordWithVelocity.odt",
				"-out", "target/ODTHelloWordWithVelocity_Out.odt", "-engine",
				"Velocity", "-jsonFile", BASE_DIR + "/JSONDataVelocity.json" };
		Main.main(args);
	}
}
