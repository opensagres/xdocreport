...
public class JAXRSResourcesServiceCGLibClientTestCase {
    ...
    @Test
    public void name() {
        ResourcesService client = JAXRSClientFactory.create(BASE_ADDRESS,
                JAXRSResourcesService.class, Providers.get());
    ...
    @Test
    public void downloadARootFile() throws FileNotFoundException, IOException {
