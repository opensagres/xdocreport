...
import fr.opensagres.xdocreport.remoting.resources.services.rest.BinaryDataMessageBodyReader;
...
public class JAXRSResourcesServiceWebClientTestCase {
    ...
    public static File srcFolder = new File(
            "src/test/resources/fr/opensagres/xdocreport/remoting/resources");
    ...
    public static void startServer() throws Exception {
        ...
        servlet.setInitParameter("javax.ws.rs.Application",
                MockJAXRSResourcesApplication.class.getName());
    ...
    public void name() {
        ...
        String name = client.path(ResourcesServiceName.name).accept(
    ...
    public void root() throws IOException {
        ...
        WebClient client = getClient();
        Resource root = client.path(ResourcesServiceName.root).accept(
    ...
    public void download() throws FileNotFoundException, IOException {
        ...
        byte[] document = client.path(path.toString()).accept(
                MediaType.APPLICATION_JSON_TYPE).get(byte[].class);
    ...
    private void createFile(byte[] flux, String filename)
        ...
        File aFile = new File(tempFolder, this.getClass().getSimpleName() + "_"
                + filename);
    ...
    public void uploadARootFile() throws FileNotFoundException, IOException {
        ...
        String resourceId = "ZzzNewSimple_" + this.getClass().getSimpleName()
                + ".docx";
        ...
        byte[] downloadedDocument = client.path(path.toString()).accept(
                MediaType.APPLICATION_JSON_TYPE).get(byte[].class);
        Assert.assertNotNull(document);
    ...
    @Test
    public void uploadAFileInFolder() throws FileNotFoundException, IOException {
        String resourceId = "ZzzCustom____NewCustomSimple_"
                + this.getClass().getSimpleName() + ".docx";
        byte[] document = IOUtils.toByteArray(Data.class.getResourceAsStream("Simple.docx"));
        ...
        Assert.assertTrue(new File(resourcesFolder,
                "ZzzCustom/NewCustomSimple_" + this.getClass().getSimpleName()
                        + ".docx").exists());
