 ...
 */
package fr.opensagres.xdocreport.examples.msword.docx;
 ...
 * 
 */
public class DocXHelloWordWithVelocity {
	...
	public static void main(String[] args) {
		try {
			...
			IXDocReport report = XDocReportRegistry.getRegistry().loadReport(
					DocXHelloWordWithVelocity.class.getResourceAsStream("DocXHelloWordWithVelocity.docx"),
