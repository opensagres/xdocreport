...
public class TestLibreOfficeWithFreemarker {
	...
	public static void main(String[] args) {
		...
		try {
			// File f = new File();;
			report.load(TestODTWithFreemarker.class
					.getResourceAsStream("TestLibreOfficeWithFreemarker.odt"));
			...
			commands.add(new Command("ref3"));
			commands.add(new Command("ref4"));
			context.put("lines", commands);

			context.put("adresse_magasin", "yessssssssssss");
			File file = new File("out/TestLibreOfficeWithFreemarker_Out.odt");
