...
public class TestODTWithVelocity {
	...
	public static void main(String[] args) {
		...
		try {
			report.load(TestODTWithVelocity.class
					.getResourceAsStream("TestODTWithVelocity.odt"));
			...
			File file = new File("out/TestODTWithVelocity_Out.docx");
