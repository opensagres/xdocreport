...
public class TestWithFreemarkerRegistry {
	...
	public static void main(String[] args) {
		try {
			...
			// Load ODT file by filling Freemarker template engine and cache it
			// to the registry
			IXDocReport report = XDocReportRegistry
					.getRegistry()
					.loadReport(
							TestWithRegistry.class
									.getResourceAsStream("TestWithFreemarkerRegistry.odt"),
	...
	private static void generate(IXDocReport report2, int i)
		...
		File file = new File(outFolder, "TestWithFreemarkerRegistry" + i
				+ "_Out.odt");
