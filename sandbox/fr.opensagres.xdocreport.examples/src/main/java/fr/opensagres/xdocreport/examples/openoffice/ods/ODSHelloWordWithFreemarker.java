 ...
 * 
 */
public class ODSHelloWordWithFreemarker {
	...
	public static void main(String[] args) {
		try {
			...
			// 2) Load ODS file by filling Freemarker template engine and cache
			// it
			// to the registry
			IXDocReport report = XDocReportRegistry
					.getRegistry()
					.loadReport(
							ODSHelloWordWithFreemarker.class
									.getResourceAsStream("ODSHelloWordWithFreemarker.ods"),
			...
			File file = new File(out, "ODSHelloWordWithFreemarker.ods");
