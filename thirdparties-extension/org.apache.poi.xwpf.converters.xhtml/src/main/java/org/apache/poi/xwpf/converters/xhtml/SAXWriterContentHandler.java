...
public class SAXWriterContentHandler
    extends DefaultHandler
{
    ...
    public SAXWriterContentHandler( OutputStream out )
    {
        this( out, null );
    }

    public SAXWriterContentHandler( Writer writer )
    {
        this( null, writer );
    }

    private SAXWriterContentHandler( OutputStream out, Writer writer )
    {
        this.out = out;
        this.writer = writer;
